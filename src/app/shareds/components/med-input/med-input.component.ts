...
@Component({
    selector: 'med-input',
    templateUrl: './med-input.component.html',
    styleUrls: ['./med-input.component.scss'],
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            multi: true,
            useExisting: forwardRef(() => MedInputComponent),
        }
    ]
})
export class MedInputComponent implements OnInit, ControlValueAccessor {
